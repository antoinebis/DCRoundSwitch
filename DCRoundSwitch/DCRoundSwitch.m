...
@synthesize on, onText, offText, onImage, offImage, knobLayerImage;
...
- (void)setKnobLayerImage:(UIImage *)newKnobImage
{
    if (newKnobImage != knobLayerImage)
    {
        [knobLayerImage release];
        knobLayerImage = [newKnobImage copy];
        knobLayer.knobLayerImage = knobLayerImage;
        [toggleLayer setNeedsDisplay];
    }
}
